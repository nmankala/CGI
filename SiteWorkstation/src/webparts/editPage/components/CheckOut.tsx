...
export default class CheckOut extends React.Component<IEditPageProps, IDetailsListCompactExampleState> {
    ...
    return (
      <div className={"container"}>
         {/*<div className={"row"} style={{ height: '50px',  background: 'brown', color:'white' }}>
                ...
                <div style={{marginTop: '15px',paddingLeft:'30px', textAlign: 'center', fontWeight: 'bold'}} className={"col-lg-10 col-md-10 col-sm-10"}>SHELL T&T OFFICE ACCESS AND SPACE BOOKING TOOL</div>
  ...
  public componentDidMount(){
    ...
    this.props.context.spHttpClient.get(this.props.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('Site Access Request Form')/items?$filter=EmailId eq '"+usermail+"' and FormStatus eq 'CheckIn'", SPHttpClient.configurations.v1).then(response => {
