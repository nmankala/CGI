...
export default class CheckIn extends React.Component<IEditPageProps, IDetailsListCompactExampleState> {
  ...
  public componentDidMount(){
    ...
    this.props.context.spHttpClient.get(this.props.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('Site Access Request Form')/items?$filter=EmailId eq '"+usermail+"' and FormStatus eq 'Submit'", SPHttpClient.configurations.v1).then(response => {
