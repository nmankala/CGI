    ...
    this.props.context.spHttpClient.post(this.props.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('Site Access Request Form')/items(" + this.props.itemID + ")", SPHttpClient.configurations.v1,
      {
        ...
        if(response.status==200){
          ...
          //window.location.href="https://eu023-sp.shell.com/sites/SPOAA1436/SitePages/New-Request.aspx?ID="+this.props.itemID
        }
        window.location.href="https://eu023-sp.shell.com/sites/SPOAA1436/SitePages/New-Request.aspx?MyID="+this.props.itemID
      });
  }
  else {
