      ...
      <div className={"container"}>
        <div className={"row"}>
          ...
          <div style={{ marginTop: '10px' }} className={"row col-lg-12 col-md-12 col-sm-12"}>
            ...
            <MultiSelect className={"col-lg-6 col-md-6 col-sm-12"} options={this.state.STA} value={this.state.STAmultiValue} onChange={this.onSTASelect} labelledBy="Select" disableSearch={true} />
